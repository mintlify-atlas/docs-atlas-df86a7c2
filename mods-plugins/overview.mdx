...
<Note>
`APPLY_EXTRA_FILES` is processed before [patch processing](/configuration/interpolation#patching-files), so it can provide baseline files to be patched at runtime.
</Note>
