...
<Note>
Before building a custom image, confirm that the desired [Java version and variant](/versions/java) isn't already provided.
</Note>
...
For development and testing, see the [Contributing Guide](/advanced/contributing) which covers:
...
- [Contributing Guide](/advanced/contributing) for development workflows